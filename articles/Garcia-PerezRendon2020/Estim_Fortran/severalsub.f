...
!*******************************
	...
	if(iwhat.eq.5)then
      filexercises='exercises_'//trim(heq2)//'e5.tex'
	elseif(iwhat.eq.6)then
      filexercises='exercises_'//trim(heq2)//'e6.tex'
	endif
...
!      write(501,*) ' &  &  &  &  & &  \\ '     
     ...
     *   (int(xexercise(j,i,types)-xexercise(1,i,types)),j=2,7)       
      ...
      if(iwhat.ge.5.and.isesu.eq.0)then
	xexercise(1,1:30,1:5)=0.d0
	isesu=1
	goto 15          
	endif
!************************************
...
!************************************
      ...
      if(iwhat.ge.4.and.itex.eq.1)then          
