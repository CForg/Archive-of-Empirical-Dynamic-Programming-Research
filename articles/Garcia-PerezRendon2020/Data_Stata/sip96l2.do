log using sip96l2, text replace
set mem 1000m
*This program reads the 1996 SIPP2 Core Longitudnal Data File 
*Note:  This program is distributed under the GNU GPL. See end of
*this file and http://www.gnu.org/licenses/ for details.
*NOTE: The dictionary files and programs for Core 1996 Longitudnal Files 1-12 are all the same;
*by Jean Roth Wed Nov 30 14:14:14 EST 2005
*Please report errors to jroth@nber.org
*run with do sip96l2
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1996\sip96l2.dat"
